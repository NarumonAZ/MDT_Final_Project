...
public class Sceen{
    public void Lobby(User user, Gamemaster master){
        ...
        Console.WriteLine("                              〚profile〛      〚friend〛      〚dungeon〛      〚shop〛      〚community〛      〚inventory〛");
    ...
    public void Profile(User user, Gamemaster master){
        ...
        Console.WriteLine("                                              〚post〛      〚check post〛      〚change name〛      〚set bio〛");
    ...
    public void Profile(User user, Gamemaster master, User searh_user){
        ...
        Console.WriteLine("                                                                〚follow〛      〚check post〛");
        Console.WriteLine("                                                                                                                                                  〚back〛");
    ...
    public void Friend(User user, Gamemaster master){
        ...
        Console.WriteLine("✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧✧");
        Console.WriteLine("|                                                                          MENU                                                                         |");
        Console.WriteLine("                                                        〚search〛      〚follow〛      〚follower〛");
        Console.WriteLine("                                                                                                                                                  〚back〛");
        bool Select = false;
        while (!Select){
            Console.Write("୨⎯  Select menu ⎯୧ | ");
    ...
    public void InGame(User user, Gamemaster master,Stage stage,List<User> party){
        ...
        while (!ForceEnd){
            ...
            Console.WriteLine("〚attack〛〚block〛〚item〛                                                                                                                       〚back〛");
                    ...
                    switch (Console.ReadLine()){
                        ...
                        case "share":
                            if (!shared){
                                ...
                                Console.WriteLine("୨⎯  System ⎯୧ | Shared post");
                            }
                        break;
                        case "back":
                            selected = true;
        ...
        static void Attack(ref Stage stage,ref User user){
            ...
            if (stage.GetMonsterCount() == 1){
                ...
                static Monster getTarget(Stage stage){
                Console.Write("୨⎯  System ⎯୧ | Select monster to attack: [number] ");
                    int num = int.Parse(Console.ReadLine()) - 1;
                    if (stage._monsterOnStage[num] != null){
                        return stage._monsterOnStage[num];
                    } else {
                        Console.WriteLine("୨⎯  System ⎯୧ | Error pls try again");
                        Console.WriteLine("");
